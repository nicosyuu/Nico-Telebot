...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = "Nico",
            BATCH_ACADEMY = "ULTRON NIGHT",
            GITHUB_REPO_LINK = "https://github.com/nicosyuu"
        )
...
df = pd.read_csv(r'C:/Users/HP/Downloads/telebot-main/data_input/facebook_ads_v2.csv', parse_dates =['reporting_date'], dayfirst= True)
...
def send_plot(message):
    ...
    if selected_campaign_id in unique_campaign:
        ...
        plot_info = list(zip(
            ['total spent' ,'approved conversion', 'average CPC'],
            df_plot.idxmax(),
            df_plot.idxmin()))
...
def echo_all(message):
    ...
    with open('template_text/default.txt', mode='r', encoding='utf-8') as f:
        ...
        default = temp.substitute( EMOJI= emoji.emojize(":beating_heart:"))
